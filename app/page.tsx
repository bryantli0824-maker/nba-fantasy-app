      ...
      <section className="px-6 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-xl text-lg font-bold transition">
              Analyze Players
            </button>
            <button className="border border-gray-700 hover:border-gray-500 text-white px-8 py-4 rounded-xl text-lg font-semibold transition">
              View Waiver Wire
            </button>
          </div>
        </div>
          ...
          {[
            {
              ...
              title: "Player Stats",
              description:
                "Season avg, last season, last 30 days, and last 14 days for every NBA player.",
            },
            {
              icon: "🚨",
              title: "Injury Alerts",
              description:
                "Real-time injury reports and player status updates before lineup lock.",
            },
            {
              icon: "✅",
              title: "Start / Sit",
              description:
                "AI-powered recommendations on who to start based on matchup and recent form.",
            },
            {
              icon: "📈",
              title: "Waiver Wire",
              description:
                "Trending pickups ranked by fantasy value so you never miss a breakout player.",
            },
          ].map((feature) => (
            <div
              key={feature.title}
              className="bg-gray-900 border border-gray-800 rounded-2xl p-6 hover:border-orange-500/40 transition cursor-pointer"
            >
      ...
      <section className="px-6 py-16">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <span className="text-gray-500 text-sm">Sample data — live stats coming soon</span>
          </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-800 text-gray-400 text-xs uppercase tracking-wider">
                    ...
                    <th className="px-4 py-4 text-center">Season PTS</th>
                ...
                <tbody>
                  {[
                    ...
                    >
                      ...
                      <td className="px-4 py-4 text-center font-mono text-orange-400 font-semibold">
                        {player.l14}
                      </td>
